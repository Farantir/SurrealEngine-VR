...
| BUG-026 | ST | S3 | ~~The player can slide through some catwalks in the lava room of DM-Conveyor.~~ **FIXED** — same root cause as BUG-062 (cylinder hit normals wrong on flat end caps). **User-confirmed fixed on re-test.** |
